...
public class AuctioneerInstance extends NpcInstance
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (actualCommand.equalsIgnoreCase("bid_confirm"))
		{
			...
			/*
			 * clanHall.getSiegeDate().setTimeInMillis(System.currentTimeMillis()); clanHall.setJdbcState(JdbcEntityState.UPDATED); clanHall.update(); clanHall.getSiegeEvent().reCalcNextTime(false);
			 */
