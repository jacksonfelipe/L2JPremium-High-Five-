...
import premium.gameserver.model.instances.BossInstance;
...
public class QueenAntInstance extends BossInstance
{
	...
	protected void onSpawn()
	{
		...
		/*
		 * final Zone zone = getZone(ZoneType.epic); if (zone != null) { for (Player player : zone.getInsidePlayers()) { if (player == null) continue; player.teleToClosestTown(); } }
		 */
	}
