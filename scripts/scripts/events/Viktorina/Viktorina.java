...
public class Viktorina extends Functions implements ScriptFile, IVoicedCommandHandler, OnPlayerEnterListener
{
	...
	/*
	 * private static boolean VIKTORINA_ENABLED = false;// false; private static boolean VIKTORINA_REMOVE_QUESTION = false;//false;; private static boolean VIKTORINA_REMOVE_QUESTION_NO_ANSWER = false;//= false; private static int VIKTORINA_START_TIME_HOUR;// 16; private static int
	 * VIKTORINA_START_TIME_MIN;// 16; private static int VIKTORINA_WORK_TIME;//2; private static int VIKTORINA_TIME_ANSER;//1; private static int VIKTORINA_TIME_PAUSE;//1;
	 */
	...
	/**
	 * Формируем окно справки. вызывается если игрок не разу не учавствовал в викторине или командой .vhelp
	 * @param player
	 */
