...
public class FightClubManager extends Functions implements ScriptFile, OnPlayerExitListener, OnTeleportListener
{
	...
	/**
	 * Gets the class {@link Rate}, containing your "applications" <b> Method for use in FightClubInstanceManager! </ b>
	 * @param index
	...
	/**
	 * Возвращает через ; имена предметов, разрешенных в качестве ставки. <b> Метод для использования в FightClubInstanceManager! </b>
	...
	/**
	 * Removes the registration of a player in the list via the method <b> Method for use in FightClubInstanceManager! </ b>
	 * @param player
	 */
	...
	/**
	 * Возвращает количеств игроков, сделавших свои ставки <b> Метод для использования в FightClubInstanceManager! </b>
	...
	/**
	 * Выводит текст по центру экрана. Выводит нескольким игрокам. Положение - TOP_CENTER
