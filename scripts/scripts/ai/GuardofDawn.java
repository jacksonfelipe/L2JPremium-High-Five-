...
/**
 * AI NPC для SSQ Dungeon - Если находят чара в радиусе 120, то кричат в чат и отправляют на точку старта - Видят и цепляют тех, кто находится в хайде - Никогда и никого не атакуют
 * @author n0nam3
