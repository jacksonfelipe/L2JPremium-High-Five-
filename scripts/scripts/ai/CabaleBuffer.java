...
public class CabaleBuffer extends DefaultAI
{
	...
	protected boolean thinkActive()
	{
		 ...
		 * Curse of Destruction (Loser) - Fighters: -25% Accuracy, -25% Effect Resistance - Mystics: -25% Casting Speed, -25% Effect Resistance Blessing of Prophecy (Winner) - Fighters: +25% Max Load, +25% Effect Resistance - Mystics: +25% Magic Cancel Resist, +25% Effect Resistance
		 */
