...
/**
 * @autor 4ipolino AI уборщицы <br>
 *        - Собирает все предметы в радиусе MAX_RADIUS <br>
 *        - убивает всех кто нанес удар (_firstTimeAttacked = true;) с выводом сообщения
 */
public class Scrubwoman extends DefaultAI
{
	...
	public int getCurrActor(NpcInstance npc)
	{
		if (Rnd.chance(90))
		{
			return 18583;
	...
	public boolean getFirstSpawned(NpcInstance actor)
	{
