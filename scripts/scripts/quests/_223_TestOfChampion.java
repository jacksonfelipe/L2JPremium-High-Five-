...
public class _223_TestOfChampion extends Quest implements ScriptFile
{
	...
	/**
	 * The Old Soldier's Friend Veteran Ascalon asks you to find his old friend Mason in the southern part of Dion.
	 */
	private static final int COND1 = 1;
	/**
	 * Mason's Revenge Mason's entire family was massacred by troops of the Gracian army. Exact his revenge upon the Bloody Axe Elites on the Plains of the Lizardmen.
	 */
	private static final int COND2 = 2;
	/**
	 * Return to Mason You've collected 100 heads of the Bloody Axe Elite. Now take them to Mason.
	 */
	private static final int COND3 = 3;
	/**
	 * Letter to Ascalon Mason is satisfied that his family has been avenged. He asks you to deliver a letter to Ascalon.
	 */
	private static final int COND4 = 4;
	/**
	 * Poison of Medusa Now you must make an antidote for the Giran guards who were poisoned by the medusa. Find Groot in Giran Castle Town.
	 */
	private static final int COND5 = 5;
	/**
	 * An Antidote for Medusa Poisoning It wasn't a mortal threat to the race, but the number medusa poisonings certainly increased. Create an antidote from a harpy's egg, the medusa's venom and windsus bile.
	 */
	private static final int COND6 = 6;
	/**
	 * Return to Groot You've gathered the ingredients to make the antidote for the medusa's venom. Return to Magic Trader Groot.
	 */
	private static final int COND7 = 7;
	/**
	 * Fight of the Old Soldiers Groot thanks you for helping him and tells you that he will make and deliver the antidote. Now return to Ascalon.
	 */
	private static final int COND8 = 8;
	/**
	 * Crisis In the Town of Oren The Town of Oren is threatened! Meet Captain Mouen there!
	 */
	private static final int COND9 = 9;
	/**
	 * Hunting the Road Scavenger The crisis in Oren was a bit overblown by Ascalon, but the road scavengers are clearly causing trouble. Bring back 100 of their heads!
	 */
	private static final int COND10 = 10;
	/**
	 * Return to Mouen You've collected 100 heads of the road scavengers. Return to Captain Mouen.
	 */
	private static final int COND11 = 11;
	/**
	 * Protect Giran Castle Ascalon was right! the Leto Lizardmen have begun a full frontal assault! You must defend Giran Castle!
	 */
	private static final int COND12 = 12;
	/**
	 * Return to the Captain You've collected 100 fangs of Leto Lizardmen. Return to Captain Mouen.
	 */
