...
public class _226_TestOfHealer extends Quest implements ScriptFile
{
	...
	/**
	 * The Girl of Prophecy Ancient revelations tell of a girl that will be born to save the world from the forces of darkness. A girl has been born who claims to be the saint described in the prophecy. Speak with Perrin in Gludin Village.
	 */
	...
	/**
	 * The Evil Perrin You've defeated Tatoma, Perrin's bodyguard. Listen to what Perrin has to say.
	 */
	...
	/**
	 * An Orphan Girl Allana scoffs and claims she only saw such a girl once, in the orphanage near Gludio Castle.
	 */
	private static final int COND5 = 5;
	/**
	 * A Poor Orphanage The orphanage is having serious financial difficulties. They could survive if only they had 100,000 adena.
	 */
	private static final int COND6 = 6;
	/**
	 * A Girl of the Wastelands The head of the orphanage gratefully accepts your 100,000 adena. But one of the girls seems to be missing.
	 */
	private static final int COND7 = 7;
	/**
	 * A Mysterious Girl Windy is a mysterious girl who talks to monsters. She says she'll return to the orphanage and asks you to go there first. Return to the orphanage.
	 */
	private static final int COND8 = 8;
	/**
	 * An Elf from Gludio You haven't find out anything about the saint, but an Elf from Gludio named Sorius might know something.
	 */
	private static final int COND9 = 9;
	/**
	 * Tracking the Followers of Shilen The girl was kidnapped by the followers of Shilen. Meet Daurin Hammercrush in the western part of the Turek Orc Camp!
	 */
	...
	/**
	 * The First Secret Letter You've defeated the Leto Lizardmen and obtained the first secret letter! Return to Daurin.
	 */
	private static final int COND12 = 12;
	/**
	 * To the Obelisk! The secret letter describes a ceremony that would take place at the obelisk in the Dark Elven Forest. You may find a clue there. Hurry up! Look for help on the way!
	 */
	private static final int COND13 = 13;
	/**
	 * Subjugate the Forces of Darkness! - Part 1 The mysterious Dark Elf has summoned new recruits! Kill them!
	 */
	private static final int COND14 = 14;
	/**
	 * Tracking the Dark Elf - Part 1 You defeated the Leto Lizardmen. Now attack the mysterious Dark Elf!
	 */
	private static final int COND15 = 15;
	/**
	 * Subjugate the Forces of Darkness! - Part 2 More recruits! Defeat them all!
	 */
	private static final int COND16 = 16;
	/**
	 * Tracking the Dark Elf - Part 2 You've defeated the Leto Lizardmen. Now attack the mysterious Dark Elf!
	 */
	private static final int COND17 = 17;
	/**
	 * Subjugate the Forces of Darkness! - Part 3 More recruits! Kill the enemy one more time!
	 */
	private static final int COND18 = 18;
	/**
	 * Tracking the Dark Elf - Part 3 You've defeated the Leto Lizardmen. This is the end! Keep attacking the mysterious Dark Elf!
	 */
	private static final int COND19 = 19;
	/**
	 * Where is the Saint? The spell that imprisoned the saint has been broken. But where is the saint? Daurin's people may know. Look for clues nearby!
	 */
	private static final int COND20 = 20;
	/**
	 * Finding the Saint The saint can be found in a tent near the Dark Elven Altar of Rites. Find her!
	 */
	private static final int COND21 = 21;
	/**
	 * The Duty of the Saint The Goddess has begun to open her eyes. Kristina says she has things to do here and asks you to deliver a letter to Master Sorius on her behalf.
	 */
	private static final int COND22 = 22;
	/**
	 * The Trial of the Healer Sorius thanks you for a job well done and promises to speak to Bandellos on your behalf. Return to Priest Bandellos.
	 */
