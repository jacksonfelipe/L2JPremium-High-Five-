...
public class _160_NerupasFavor extends Quest implements ScriptFile
{
	...
	/**
	 * Delivery of Goods Trader Unoren asked Nerupa to collect silvery spidersilks for him. Norupa doesn't want to enter the village and asks you to deliver the silvery spidersilks to Trader Unoren in the weapons shop and bring back a nightshade leaf. *
	 */
	private static int COND1 = 1;
	
	/**
	 * Nightshade Leaf Nightshade leaves are very rare. Fortunately, Trader Creamees of the magic shop has obtained a few of them. Go see him with Unoren's receipt.
	 */
	private static int COND2 = 2;
	
	/**
	 * Go to the Warehouse Since nightshade leaf is so rare it has been stored in the warehouse. Take Creamees' ticket to Warehouse Keeper Julia.
	 */
	private static int COND3 = 3;
	
	/**
	 * Goods to be Delivered to Nerupa You've obtained the nightshade leaf that Creamees stored in the warehouse. Deliver it to Nerupa.
	 */
