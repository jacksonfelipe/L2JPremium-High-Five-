...
public class Augmentation extends Functions
{
	...
	public boolean check(ItemInstance item)
	{
	...
	public List<OptionDataTemplate> checkAugmentations(Collection<OptionDataTemplate> augmentations)
	{
		final List<OptionDataTemplate> checkedAugmentations = new ArrayList<>(augmentations.size());
