...
public class CommunityForum implements ScriptFile, ICommunityBoardHandler
{
	...
	public void showMainPage(Player player)
	{
		...
		/*
		 * // Marketplace board final ForumBoard marketBoard = ForumHandler.getInstance().getBoardByIndex(ForumBoardType.BUG_TRACKER.getBoardIndex()); html = html.replace("%marketBoardIndex%", String.valueOf(marketBoard.getType().getBoardIndex())); html = html.replace("%marketPostsCount%",
		 * String.valueOf(marketBoard.getPostsCount())); html = html.replace("%marketTopicsCount%", String.valueOf(marketBoard.getTopicsCount())); if (marketBoard.getLastPost() != null) { html = html.replace("%marketLastPost%", "<font color=" +
		 * marketBoard.getLastPost().getWriter().getMemberGroup().getColor() + ">" + marketBoard.getLastPost().getWriter().getMemberName() + "</font>"); html = html.replace("%marketTime%", "<font color=63bea6>" + POST_TIME.format(marketBoard.getLastPost().getDate()) + "</font>"); } else { html =
		 * html.replace("%marketLastPost%", ""); html = html.replace("%marketTime%", ""); }
		 */
		// Bug Tracker board
		...
		/*
		 * // Suggestions board final ForumBoard suggestionsBoard = ForumHandler.getInstance().getBoardByIndex(ForumBoardType.SUGGESTIONS.getBoardIndex()); html = html.replace("%bugBoardIndex%", String.valueOf(suggestionsBoard.getType().getBoardIndex())); html = html.replace("%bugPostsCount%",
		 * String.valueOf(suggestionsBoard.getPostsCount())); html = html.replace("%bugTopicsCount%", String.valueOf(suggestionsBoard.getTopicsCount())); if (suggestionsBoard.getLastPost() != null) { html = html.replace("%bugLastPost%", "<font color=" +
		 * suggestionsBoard.getLastPost().getWriter().getMemberGroup().getColor() + ">" + suggestionsBoard.getLastPost().getWriter().getMemberName() + "</font>"); html = html.replace("%bugTime%", "<font color=63bea6>" + POST_TIME.format(suggestionsBoard.getLastPost().getDate()) + "</font>"); } else
		 * { html = html.replace("%bugLastPost%", ""); html = html.replace("%bugTime%", ""); }
		 */
	...
	public void showConnectAccountPage(Player player)
	{
	...
	public void showConnectAccountErrorPage(Player player, String errorMsg)
	{
	...
	public void showBoardPage(Player player, ForumBoard board, int page)
	{
	...
	public void showPostPage(Player player, ForumPost post)
	{
	...
	public void showNewTopicPage(Player player, ForumBoard board)
	{
		final int boardIndex = board.getType().getBoardIndex();
	...
	public void showNewReplyPage(Player player, ForumTopic topic, String communityArgsValue)
	{
