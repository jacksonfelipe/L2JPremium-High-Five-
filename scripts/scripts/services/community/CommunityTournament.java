...
import premium.gameserver.model.entity.tournament.TournamentStatus;
import premium.gameserver.model.entity.tournament.TournamentTeamsManager;
...
public class CommunityTournament implements ScriptFile, ICommunityBoardHandler
{
	...
	public void showRegistrationPage(Player player)
	{
	...
	public void showRegistrationErrorPage(Player player, String errorMsg)
	{
	...
	public void showRegistrationInfoPage(Player player)
	{
	...
	public void showBattleRulesPage(Player player)
	{
	...
	public String makeTeamContent(Team myTeam, Team team)
	{
	...
	public String makeEmptyTeamContent()
	{
		final StringBuilder builder = new StringBuilder();
		boolean nextColor = false;
	...
	public String makeBattleStartDateContent(BattleRecord battle)
	{
		final StringBuilder builder = new StringBuilder();
	...
	private void tryToRegisterTeam(Player player)
	{
		...
		if (player.getParty() == null)
		{
			...
			final List<Player> members = new ArrayList<>(1);
			members.add(player);
