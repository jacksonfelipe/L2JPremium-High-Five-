...
import premium.gameserver.utils.ValueSortMap;
...
public class CommunityAugment implements ScriptFile, ICommunityBoardHandler
{
	...
	private static List<AugmentationData> _augdata = new ArrayList<>();
	...
	public boolean checkItemValiable(ItemInstance im)
	{
	...
	public void showLSPage(Player player, int page)
	{
	...
	public static List<AugmentationData> getSorttedAugmentation(SortBy sort, List<AugmentationData> aug)
	{
		...
		final List<AugmentationData> sorted = new ArrayList<>();
		switch (sort)
		{
			default:
			case ALL:
	...
	private static List<AugmentationData> getFilteredAugData(String filter)
	{
		...
		final List<AugmentationData> filteredList = new ArrayList<>();
