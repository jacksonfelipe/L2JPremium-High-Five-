...
import premium.gameserver.multverso.facebook.TaskNoAvailableException;
...
public class CommunityFacebook implements ScriptFile, ICommunityBoardHandler
{
	...
	public void showConfirmIndentityStartInfoPage(Player player)
	{
	...
	public void makeActionTypeTable(StringBuilder sb, FacebookActionType actionType, boolean nextColor, boolean rewarded)
	{
	...
	public void showTaskDelayPage(Player player)
	{
	...
	public void showActiveTaskDetailsPage(Player player)
	{
	...
	public int getBiggestLevel(Player player)
	{
