...
// else
// html = html.replace("%sortName%", "<font color=FFFFFF><button value=\"Clan Name\" action=\"bypass _bbsclan_changeSort_" + searchClanName + "_" + searchPlayerName + "_" + searchAllianceName + "_NAME\" width=128 height=15 back=\"L2UI_CT1.ListCTRL_DF_Title_Down\"
// fore=\"L2UI_CT1.ListCTRL_DF_Title\">");
//
// // Sort Base
// if (sortType == SortType.BASE)
// html = html.replace("%sortBase%", "<font color=FFFFFF>Base</font>");
// else
// html = html.replace("%sortBase%", "<font color=FFFFFF><button value=\"Clan Base\" action=\"bypass _bbsclan_changeSort_" + searchClanName + "_" + searchPlayerName + "_" + searchAllianceName + "_BASE\" width=128 height=15 back=\"L2UI_CT1.ListCTRL_DF_Title_Down\"
// fore=\"L2UI_CT1.ListCTRL_DF_Title\">");
//
...
// {
// return (searchClanName.isEmpty() || StringUtils.containsIgnoreCase(clan.getName(), searchClanName)) && (searchPlayerName.isEmpty() || getFirstMemberByName(clan, searchPlayerName) != null) && (searchAllianceName.isEmpty() || clan.getAlliance() != null &&
// StringUtils.containsIgnoreCase(clan.getAlliance()
// .getAllyName(),
// searchAllianceName));
// }
//
