...
import premium.gameserver.model.entity.auction.AccessoryItemType;
import premium.gameserver.model.entity.auction.ArmorItemType;
import premium.gameserver.model.entity.auction.Auction;
import premium.gameserver.model.entity.auction.AuctionItemTypes;
import premium.gameserver.model.entity.auction.AuctionManager;
import premium.gameserver.model.entity.auction.EtcAuctionItemType;
import premium.gameserver.model.entity.auction.PetItemType;
import premium.gameserver.model.entity.auction.SuppliesItemType;
import premium.gameserver.model.entity.auction.WeaponItemType;
import premium.gameserver.model.items.AuctionStorage;
...
public class CommunityAuctionHouse implements ScriptFile, ICommunityBoardHandler
{
			...
			if (buttonClicked != null)
			{
				...
				else if (buttonClicked.equals("1"))
				{
					...
					if (item == null)
					{
						...
						// sold
						/*
						 * Collection<Auction> auctions = AuctionManager.getInstance().getMyAuctions(player.getObjectId()); for (Auction a : auctions) { if (a.getItem() == null) _log.error("Auction bugged! Item:null itemId:" + currentObjectId + " auctionId:" + a.getAuctionId() + " Count:" +
						 * a.getCountToSell() + " Price:" + a.getPricePerItem() + " Seller:" + a.getSellerName() + "[" + a.getSellerObjectId() + "] store:" + a.isPrivateStore()); else _log.error("Auction bugged! Item:" + a.getItem().getName() + " itemId:" + currentObjectId + " playerInv:" +
						 * player.getInventory().getItemByObjectId(player.getObjectId()) + " auctionId:" + a.getAuctionId() + " Count:" + a.getCountToSell() + " Price:" + a.getPricePerItem() + " Seller:" + a.getSellerName() + "[" + a.getSellerObjectId() + "] store:" + a.isPrivateStore());
	 ...
	 */
	public List<ItemInstance> getItemsToAuction(Player player)
	{
	 ...
	 * @return
	 */
	public int getFunc(ItemInstance item, Stats stat)
	{
	 ...
	 * @return
	 */
	public String getElementColor(Element element)
	{
		switch (element)
		{
			case EARTH:
	 ...
	 * @return
	 */
	public String getGradeIcon(Grade grade)
	{
		if (grade != Grade.NONE)
		{
	 ...
	 * @return
	 */
	public AuctionItemTypes[] getGroupsInType(int type)
	{
		if (type > 0 && type < 7)
		{
	...
	public List<Auction> sortAuctions(List<Auction> auctionsToSort, int itemSort, int gradeSort, int quantitySort, int priceSort)
	{
		if (itemSort != 0)
		{
