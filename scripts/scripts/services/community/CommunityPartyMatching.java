...
public class CommunityPartyMatching extends Functions implements ScriptFile, ICommunityBoardHandler
{
	...
	public String replace(String text, int classesSortType, int sortType, int asc, int page, int charObjId)
	{
	...
	public boolean containsClass(ClassId[] group, int clazz)
	{
	...
	public int getUnlocksSize(Player player, int classSortType)
	{
	...
	public ClassId[] getNeededClasses(int type)
	{
		switch (type)
		{
			case 0: // All
	...
	public String getChecked(int i, int classSortType)
	{
		if (classSortType == i)
		{
