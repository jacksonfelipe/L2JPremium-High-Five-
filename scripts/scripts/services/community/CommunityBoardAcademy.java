...
import premium.gameserver.listener.actor.player.impl.AcademyAnswerListener;
...
import premium.gameserver.multverso.academy.AcademyRewards;
...
public class CommunityBoardAcademy implements ScriptFile, ICommunityBoardHandler
{
	...
	public void showAcademList(Player player, int page)
	{
