...
import premium.gameserver.network.clientpackets.CharacterCreate;
...
public class CommunityNpcs implements ScriptFile, ICommunityBoardHandler
{
	...
	public String[] fillReplacements(String[] currentReplacements, String stringInside, int count)
	{
