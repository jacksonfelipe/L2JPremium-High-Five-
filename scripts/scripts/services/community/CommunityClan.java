...
public class CommunityClan extends Functions implements ScriptFile, ICommunityBoardHandler
{
	...
	public void showEditClanNoticePage(Player player, String communityArgsValue)
	{
	...
	public void makeSkillTr(StringBuilder st, Skill skill)
	{
	...
	public void makeEmptyClanListTable(StringBuilder st, Player player, int index, String searchClanName, String searchPlayerName, String searchAllianceName, int page)
	{
		st.append("<table>");
		st.append("<tr>");
		st.append("<td align=center>");
	...
	public void makeFilledEditBox(StringBuilder st, String content)
	{
	...
	public static Clan[] getSortedClans(Player player, String searchClanName, String searchPlayerName, String searchAllianceName)
	{
		...
		final List<Clan> searchedClans = new ArrayList<>(sortedClans.length);
	...
	public enum SortType
	{
		...
		public int compare(Clan o1, Clan o2)
		{
			switch (this)
			{
				...
				{
					/*
					 * final int membersCompare = Integer.compare(o2.getOnlineMembers().size(), o1.getOnlineMembers().size()); if (membersCompare != 0) return membersCompare; final int castleCompare = Boolean.compare(o2.getCastle() > 0, o1.getCastle() > 0); if (castleCompare != 0) return
					 * castleCompare; final int fortressCompare = Boolean.compare(o2.getHasFortress() > 0, o1.getHasFortress() > 0); if (fortressCompare != 0) return fortressCompare; return Integer.compare(o1.getClanId(), o2.getClanId());
					 */
...
// import premium.gameserver.model.pledge.Clan;
// import premium.gameserver.model.pledge.Clan.SinglePetition;
...
// html = html.replace("%joinClanButton%", "<br><center><button action=\"bypass _bbsclanjoin_" + clan.getClanId() + "_1 | $answer1 | $answer2 | $answer3 | $answer4 | $answer5 | $answer6 | $answer7 | $answer8 | $comment |\" value=\"Send\" width=320 height=25 back=\"L2UI_CT1.Button_DF_Down\"
...
//// if (!clan.isRecruting() || clan.isFull()) / text += "<center><button action=\"bypass _clbbslist_" + page + "\" value=\"Recrutation Closed\" width=200 height=20 back=\"L2UI_CT1.OlympiadWnd_DF_Apply_Down\" fore=\"L2UI_CT1.OlympiadWnd_DF_Apply\"></center>"; / else if (player.getClan() != null) /
/// text += "<center><button action=\"bypass _clbbslist_" + page + "\" value=\"Recrutation Opened\" width=200 height=20 back=\"L2UI_CT1.OlympiadWnd_DF_Apply_Down\" fore=\"L2UI_CT1.OlympiadWnd_DF_Apply\"></center>"; / else / text += "<center><button action=\"bypass _bbsclanjoin_" + clan.getClanId() +
/// "_0\" value=\"Join Clan\" width=200 height=31 back=\"L2UI_CT1.OlympiadWnd_DF_Apply_Down\" fore=\"L2UI_CT1.OlympiadWnd_DF_Apply\"></center>";
//
// text += "</td></tr></table>";
// text += "</td></tr>";
// index++;
