...
public class Roulette extends Functions
{
	...
	/*
	 * type это тип ставки, number это на что именно ставка type 1: Ставка на один номер (Straight Up), number соответствует номеру, выплата 35:1 type 10: Column Bet, на столбец, number номер столбца, выплата 2:1, zero автоматический проигрыш type 11: Dozen Bet, на дюжину, number номер дюжины,
	 * выплата 2:1, zero автоматический проигрыш type 12: Red or Black, на цвет, number цвет (0=R,1=B), выплата 1:1, zero автоматический проигрыш type 13: Even or Odd, чет-нечет, number тип (0=even,1=odd), выплата 1:1, zero автоматический проигрыш type 14: Low or High, 0=1-18,1=19-36, выплата 1:1,
