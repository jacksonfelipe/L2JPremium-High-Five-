...
public class KashaNegate implements ScriptFile
{
	...
	public void changeAura(NpcInstance actor, int npcId)
	{
	...
	public void broadcastKashaMessage(int message, Zone zone)
	{
	...
	public void addEffect(NpcInstance actor, Creature player, Skill skill, boolean animation)
	{
	...
	public int getRealNpcId(NpcInstance npc)
	{
