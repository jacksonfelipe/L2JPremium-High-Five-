...
/**
 * StrTable table = new StrTable("Test Table :)"); table.set(0, "#", 1).set(0, "val", 23.5).set(0, "desc", " value #1"); table.set(1, "#", 2).set(1, "v", 22.5).set(1, "desc", " value #2"); table.set(3, "#", 3).set(3, "val", true).set(3, "desc", " bool #3 1334"); table.set(2, "#", -1).set(2, "v",
 * 22.5).set(2, "desc", "#######"); System.out.print(table); Test Table :) ---------------------------------- | # | val | desc | v | |----|------|---------------|------| | 1 | 23.5 | value #1 | - | | 2 | - | value #2 | 22.5 | | -1 | - | ####### | 22.5 | | 3 | true | bool #3 1334 | - |
 * ----------------------------------
 * @Author: Drin
 * @Date: 27/04/2009
 */
