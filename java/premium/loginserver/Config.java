...
import premium.commons.configuration.ExProperties;
import premium.commons.util.Rnd;
import premium.loginserver.crypt.PasswordHash;
import premium.loginserver.crypt.ScrambledKeyPair;
import premium.loginserver.panel.gui.AuthUiLog;
...
public class Config
{
	...
	public static final void initCrypt() throws Throwable
	{
		...
		AuthUiLog.info("Loaded " + Config.DEFAULT_PASSWORD_HASH + " as default crypt.");
		...
		AuthUiLog.info("Loaded " +"Cached " + _keyPairs.length + " KeyPairs for RSA communication");
		...
		AuthUiLog.info("Stored " + _blowfishKeys.length + " keys for Blowfish communication");
	...
	public static final void loadServerNames()
	{
		...
		try
		{
			...
			AuthUiLog.info("Loaded " + SERVER_NAMES.size() + " server names");
