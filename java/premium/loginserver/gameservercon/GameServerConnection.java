...
import premium.loginserver.Config;
import premium.loginserver.ThreadPoolManager;
import premium.loginserver.gameservercon.lspackets.PingRequest;
...
public class GameServerConnection
{
	...
	/**
	 * Ping system: После авторизации игрвого сервера запускается PingTask с Config.GAME_SERVER_PING_DELAY - он посылает пакет и запускает такс PingCheckTask - который ждет ответ он ГС, если ответ непрыбыл, ГС умер, и про это будет написано в консоль
	 */
