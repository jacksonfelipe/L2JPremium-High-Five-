...
public final class GamePanel extends JFrame
{
	...
	private static int getOnlinePlayersReflective()
	{
		try
		{
			Class<?> clazz = Class.forName("premium.gameserver.model.GameObjectsStorage");
		...
		String[][] methods =
		{
			{ "premium.gameserver.model.World", "getInstance", "getAllPlayersCount" },
			{ "premium.gameserver.model.World", "getInstance", "getPlayersCount" },
			{ "premium.gameserver.model.World", "getInstance", "getOnlinePlayersCount" }
		};
