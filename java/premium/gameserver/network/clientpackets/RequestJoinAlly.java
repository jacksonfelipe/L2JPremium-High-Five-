...
import premium.gameserver.network.serverpackets.AskJoinAlliance;
...
public class RequestJoinAlly extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("premium.gameserver.clientpackets.RequestJoinAlly.InvitePenalty", activeChar));
			return;
		}
