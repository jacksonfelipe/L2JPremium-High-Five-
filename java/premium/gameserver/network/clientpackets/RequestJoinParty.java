...
import premium.gameserver.network.serverpackets.AskJoinParty;
...
public class RequestJoinParty extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (activeChar.isInParty())
		{
			...
			{
				activeChar.sendMessage(new CustomMessage("premium.gameserver.clientpackets.RequestJoinParty.InDimensionalRift", activeChar));
				activeChar.sendActionFailed();
				return;
			}
		}
