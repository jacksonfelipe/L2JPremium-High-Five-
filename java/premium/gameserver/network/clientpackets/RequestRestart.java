...
import premium.gameserver.network.serverpackets.RestartResponse;
...
public class RequestRestart extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("premium.gameserver.clientpackets.Logout.Olympiad", activeChar));
		...
		if (activeChar.isFestivalParticipant())
		{
			...
			{
				activeChar.sendMessage(new CustomMessage("premium.gameserver.clientpackets.RequestRestart.Festival", activeChar));
				activeChar.sendPacket(RestartResponse.FAIL, ActionFail.STATIC);
				return;
			}
		}
