...
import premium.gameserver.model.actor.instances.player.Macro.L2MacroCmd;
import premium.gameserver.network.serverpackets.components.SystemMsg;

/**
 * packet type id 0xcd sample cd d // id S // macro name S // unknown desc S // unknown acronym c // icon c // count c // entry c // type d // skill id c // shortcut id S // command name format: cdSSScc (ccdcS)
 */
