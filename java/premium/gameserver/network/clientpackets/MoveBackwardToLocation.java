...
public class MoveBackwardToLocation extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		premium.gameserver.inertiax.model.Inertia inertia = premium.gameserver.inertiax.controller.InertiaController.getInstance().getInertia(activeChar);
		if (inertia != null)
		{
			premium.gameserver.inertiax.model.InertiaPanel panel = inertia.getPanel(premium.gameserver.inertiax.enums.EPanelOption.Path_Editor);
			if (panel instanceof premium.gameserver.inertiax.model.panels.PathEditor)
			{
				...
				premium.gameserver.inertiax.model.panels.InertiaPath selPath = pe.getSelePath();
