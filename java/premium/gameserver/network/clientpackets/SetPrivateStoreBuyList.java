	...
	protected void runImpl()
	{
		...
		try
		{
			...
			for (int i = 0; i < this._count; i++)
			{
				...
				{
					buyer.sendMessage(new CustomMessage("premium.gameserver.clientpackets.SetPrivateStoreBuyList.TooLowPrice", buyer).addItemName(item).addNumber(item.getReferencePrice() / 2));
					continue;
				}
