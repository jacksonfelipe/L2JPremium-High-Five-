package premium.gameserver.multverso.tournament.model;
...
import premium.gameserver.multverso.tournament.TournamentConfig;
...
public abstract class AbstractTournament
{
	...
	public synchronized void handleRegUnReg(Player player)
	{
		...
		for (ItemHolder holder : TournamentConfig.REQUIRES)
		{
			...
			{
				player.sendMessage("You don't have " + holder.getCount() + " " + premium.gameserver.data.xml.holder.ItemHolder.getInstance().getItemName(holder.getItemId()));
				return;
			}
		}
