 ...
 */
package premium.gameserver.multverso.managers;
...
public class MailManager
{
	...
	public boolean canPlayerSendMail(Player player)
	{
		...
		/*
		 * if (System.currentTimeMillis() > mails.get(mails.size() - 1)) { player.sendMessage("You must wait " + (MAIL_SEND_REUSE / 60000) + " minute/s between each mail sent"); return false; }
		 */
