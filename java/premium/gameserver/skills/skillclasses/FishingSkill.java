...
public class FishingSkill extends Skill
{
	...
	public void useSkill(Creature caster, List<Creature> targets)
	{
		...
		int group = premium.gameserver.model.Fishing.getFishGroup(lure.getItemId());
		int type = premium.gameserver.model.Fishing.getRandomFishType(lureId);
		int lvl = premium.gameserver.model.Fishing.getRandomFishLvl(player);
