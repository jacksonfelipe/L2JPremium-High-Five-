...
import premium.gameserver.model.PetData;
...
public class PetInstance extends Summon
{
	...
	class FeedTask extends RunnableImpl
	{
		...
		public void runImpl()
		{
			...
			else if (getCurrentFed() <= 0.10 * getMaxFed())
			{
				...
				owner.sendMessage(new CustomMessage("premium.gameserver.model.instances.L2PetInstance.UnSummonHungryPet", owner));
				unSummon();
				return;
			}
	...
	public void addExpAndSp(long addToExp, long addToSp)
	{
		...
		if (old_level < _level)
		{
			owner.sendMessage(new CustomMessage("premium.gameserver.model.instances.L2PetInstance.PetLevelUp", owner).addNumber(_level));
