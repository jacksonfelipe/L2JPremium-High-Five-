		...
		else if (command.startsWith("Festival"))
		{
			...
			switch (val)
			{
				...
				case 2: // Festival 2 xxxx
					...
					{
						player.sendMessage(new CustomMessage("premium.gameserver.model.instances.L2FestivalGuideInstance.InProgress", player));
						return;
					}
					...
					{
						player.sendMessage(new CustomMessage("premium.gameserver.model.instances.L2FestivalGuideInstance.NotEnoughSSType", player));
						return;
					}
