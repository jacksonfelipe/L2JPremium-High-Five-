...
//import premium.gameserver.model.entity.CCPHelpers.CCPAccountRecover;
...
import premium.gameserver.model.entity.CCPHelpers.CCPRepair;
...
public class CharacterControlPanel
{
	...
	public String useCommand(Player activeChar, String text, String bypass)
	{
		...
		/*
		 * else if (param[0].equalsIgnoreCase("accountRecover")) { if (param.length > 1) { CCPAccountRecover.recoverAccounts(activeChar, param[1]); return null; } else { CCPAccountRecover.sendMainHtml(activeChar); return null; } }
		 */
