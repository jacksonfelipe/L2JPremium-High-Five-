package premium.gameserver.model.entity.events.fightclubmanager;
...
public class FightClubEventManager
{
	...
	/**
	 * Checking {@link #canPlayerParticipate(premium.gameserver.model.Player, boolean, boolean)} for every player participated in event. Sending Message, checking all condtions
