...
import premium.gameserver.model.actor.permission.PlayablePermissionList;
...
public abstract class Playable extends Creature
{
	...
	public void doAttack(Creature target)
	{
		...
		{
			player.sendMessage(new CustomMessage("premium.gameserver.model.L2Playable.OutOfControl.ObserverNoAttack", player));
			return;
		}
