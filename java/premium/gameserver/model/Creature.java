...
import premium.commons.util.concurrent.atomic.AtomicState;
...
import premium.gameserver.geodata.GeoMove;
...
import premium.gameserver.model.GameObjectTasks.AltMagicUseTask;
import premium.gameserver.model.GameObjectTasks.CastEndTimeTask;
import premium.gameserver.model.GameObjectTasks.HitTask;
import premium.gameserver.model.GameObjectTasks.MagicCheckTask;
import premium.gameserver.model.GameObjectTasks.MagicLaunchedTask;
import premium.gameserver.model.GameObjectTasks.MagicUseTask;
import premium.gameserver.model.GameObjectTasks.NotifyAITask;
...
import premium.gameserver.model.actor.permission.CharPermissionList;
import premium.gameserver.model.actor.recorder.CharStatsChangeRecorder;
...
import premium.gameserver.network.serverpackets.Attack;
import premium.gameserver.network.serverpackets.AutoAttackStart;
import premium.gameserver.network.serverpackets.AutoAttackStop;
import premium.gameserver.network.serverpackets.ChangeMoveType;
import premium.gameserver.network.serverpackets.CharMoveToLocation;
...
import premium.gameserver.network.serverpackets.MagicSkillCanceled;
...
import premium.gameserver.stats.Calculator;
import premium.gameserver.stats.Env;
import premium.gameserver.stats.Formulas;
import premium.gameserver.stats.Formulas.AttackInfo;
import premium.gameserver.stats.StatFunctions;
...
import premium.gameserver.taskmanager.RegenTaskManager;
import premium.gameserver.templates.CharTemplate;
import premium.gameserver.templates.item.ItemTemplate.Grade;
...
public abstract class Creature extends GameObject
{
	...
	protected void onDeath(Creature killer)
	{
		if (killer != null)
		{
			...
			if (killerPlayer != null)
			{
				...
				premium.gameserver.inertiax.model.Inertia inertia = premium.gameserver.inertiax.controller.InertiaController.getInstance().getInertia(killerPlayer);
				if (inertia != null)
				{
					inertia.onKill(this);
				}
	...
	/**
	 * @param timeInMilis
	 * @return if the character was attacked in the past timeInMilis
	 */
