...
import premium.commons.text.StrTable;
...
public class GameObjectsStorage
{
	...
	/**
	 * A copy of the list of players from the store suitable for manipulation over her To iterate mostly better use getAllPlayersForIterate()
	 * @return
	 */
	...
	public static int getRealOnlinePlayersCount()
	{
		int count = 0;
		for (Player player : getStoragePlayers())
		{
