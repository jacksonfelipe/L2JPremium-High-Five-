...
import premium.gameserver.model.entity.events.EventOwner;
...
public abstract class GameObject extends EventOwner
{
	...
	/**
	 * Удаляет объект из текущего региона, делая его невидимым. Не путать с deleteMe. Объект после decayMe подлежит реюзу через spawnMe. Если перепутать будет утечка памяти.
	 */
