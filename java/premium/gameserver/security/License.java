package premium.gameserver.security;
	...
	public static void main(String[] args)
	{
		try
		{
			...
			while (rs.next())
			{
				...
				/*
				 * String lastName = rs.getString("last_name"); Date dateCreated = rs.getDate("date_created"); boolean isAdmin = rs.getBoolean("is_admin"); int numPoints = rs.getInt("num_points");
				 */
				// print the results
				System.out.format("%s\n", server_ip);
			}
