...
import premium.gameserver.data.ConfigParser;
...
import premium.gameserver.utils.DynamicConfig;
...
public final class ConfigHolder extends AbstractHolder
{
	...
	private final Map<String, DynamicConfig> convertedConfigs = new HashMap<>();
