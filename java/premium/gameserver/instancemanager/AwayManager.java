...
public final class AwayManager
{
	...
	public void setAway(Player activeChar, String text)
	{
		...
		activeChar.sendMessage(new CustomMessage("premium.gameserver.instancemanager.AwayManager.setAway", activeChar, new Object[]
		{
	...
	{
		activeChar.sendMessage(new CustomMessage("premium.gameserver.instancemanager.AwayManager.setBack", activeChar, new Object[]
		{
	...
	private class setPlayerBackTask implements Runnable
	{
		...
		public void run()
		{
			...
			_activeChar.sendMessage(new CustomMessage("premium.gameserver.instancemanager.AwayManager.setPlayerBackTask", _activeChar, new Object[0]));
		}
	}
	...
	private class setPlayerAwayTask implements Runnable
	{
		...
		public void run()
		{
			...
			{
				_activeChar.sendMessage(new CustomMessage("premium.gameserver.instancemanager.AwayManager.setPlayerAwayTask.Sitting", _activeChar, new Object[0]));
				return;
			}
			...
			{
				_activeChar.sendMessage(new CustomMessage("premium.gameserver.instancemanager.AwayManager.setPlayerAwayTask.NoText", _activeChar, new Object[0]));
			}
			else
			{
				_activeChar.sendMessage(new CustomMessage("premium.gameserver.instancemanager.AwayManager.setPlayerAwayTask", _activeChar, new Object[]
				{
					_awayText
				}));
			}
