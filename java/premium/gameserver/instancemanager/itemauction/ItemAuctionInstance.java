		...
		public void runImpl()
		{
			...
			switch (state)
			{
				case CREATED:
				{
					...
					{
						String[] params = {};
						Announcements.getInstance().announceByCustomMessage("premium.gameserver.model.instances.L2ItemAuctionBrokerInstance.announce." + _auction.getInstanceId(), params);
					}
					checkAndSetCurrentAndNextAuction();
					break;
				}
