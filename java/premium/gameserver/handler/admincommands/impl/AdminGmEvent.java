...
import premium.gameserver.multverso.managers.GmEventManager.EventParameter;
import premium.gameserver.multverso.managers.GmEventManager.StateEnum;
import premium.gameserver.network.serverpackets.NpcHtmlMessage;

/**
 * Un engine simple para facilitar la tarea de los gms a la hora de hacer un evento manual Desde aca se puede crear el evento, detenerlo, controlar los pjs registrados, etc
 * @author Prims
 */
