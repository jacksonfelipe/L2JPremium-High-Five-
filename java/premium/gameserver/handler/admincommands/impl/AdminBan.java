...
public class AdminBan implements IAdminCommandHandler
{
	...
	public boolean tradeBan(StringTokenizer st, Player activeChar)
	{
		if ((activeChar.getTarget() == null) || !activeChar.getTarget().isPlayer())
		{
			return false;
	...
	public boolean tradeUnban(StringTokenizer st, Player activeChar)
	{
		if ((activeChar.getTarget() == null) || !activeChar.getTarget().isPlayer())
		{
			return false;
	...
	public boolean ban(StringTokenizer st, Player activeChar)
	{
		try
		{
			st.nextToken();
