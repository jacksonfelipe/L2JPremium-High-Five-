...
import premium.gameserver.network.serverpackets.PledgeShowMemberListAdd;
	...
	public boolean useAdminCommand(Enum comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		switch (command)
		{
			...
			case admin_phantoms_enable:
				...
				activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.admincommands.impl.AdminPhantoms.message1", activeChar));
			...
			case admin_phantoms_disable:
				...
				activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.admincommands.impl.AdminPhantoms.message2", activeChar));
				activeChar.sendPacket(new NpcHtmlMessage(5).setFile("admin/phantoms.htm").replace("%phantomcount%", "" + PhantomPlayers.getSpawnedPhantomsCount()));
				break;
				...
				if (wordList.length > 1)
				{
					...
					else
					{
						...
						if (phantom == null)
						{
							...
							activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.admincommands.impl.AdminPhantoms.message3", activeChar).addString(wordList[1]));
						}
			...
			case admin_phantoms_spawner:
				try
				{
					...
					activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.admincommands.impl.AdminPhantoms.message4", activeChar));
					
				}
				catch (Exception e)
				{
					// Original Message: Usage: //phantoms_spawner numSpawns [delayInMilis] [true for generateNew]
					activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.admincommands.impl.AdminPhantoms.message5", activeChar));
				}
				break;
			...
			case admin_phantoms_stop_spawning:
				...
				activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.admincommands.impl.AdminPhantoms.message6", activeChar));
				break;
			case admin_phantoms_spawn:
				try
				{
					...
					{
						activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.admincommands.impl.AdminPhantoms.message10", activeChar));
						return false;
					}
					...
					if (hasClan != "")
					{
						...
						if (rndbotwithclan == -1)
						{
							...
							if (clanPhantom == null)
							{
								activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.admincommands.impl.AdminPhantoms.message8", activeChar));
								return false;
							}
						...
						activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.admincommands.impl.AdminPhantoms.message9", activeChar).addString(name));
					...
					if (phantom != null)
					{
						...
						activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.admincommands.impl.AdminPhantoms.message9", activeChar).addString(phantom.getName()));
			...
			case admin_phantoms_ai:
				if (activeChar.getTarget() == null || !activeChar.getTarget().isPlayer())
				{
					...
					activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.admincommands.impl.AdminPhantoms.message11", activeChar));
				}
				else if (!activeChar.getTarget().getPlayer().getAI().isPhantomPlayerAI())
				{
					// Original Message: Target is not phantom.
					activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.admincommands.impl.AdminPhantoms.message12", activeChar));
				}
				else
				{
					...
					if (wordList.length == 1)
					{
						...
						activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.admincommands.impl.AdminPhantoms.message13", activeChar).addString(ai.getIntention().toString()));
						// Original Message: Mood: " + ai.getMood()
						activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.admincommands.impl.AdminPhantoms.message14", activeChar).addString(ai.getMood()));
						// Original Message: AttackTarget: " + ai.getAttackTarget()
						activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.admincommands.impl.AdminPhantoms.message15", activeChar).addString(ai.getAttackTarget() != null ? ai.getAttackTarget().toString() : "none"));
					}
