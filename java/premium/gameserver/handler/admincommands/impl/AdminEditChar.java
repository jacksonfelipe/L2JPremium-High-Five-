...
import premium.gameserver.network.loginservercon.gspackets.ChangePassword;
...
public class AdminEditChar implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(@SuppressWarnings("rawtypes") Enum comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		else if (fullString.startsWith("admin_setsubclass"))
		{
			...
			if (st.countTokens() > 1)
			{
				...
				{
					activeChar.sendMessage(new CustomMessage("premium.gameserver.model.instances.L2VillageMasterInstance.SubclassCouldNotBeAdded", activeChar));
					return false;
				}
	...
	private void setSubclass(Player activeChar, Player player)
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("premium.gameserver.model.instances.L2VillageMasterInstance.NoSubAtThisTime", activeChar));
			return;
		}
