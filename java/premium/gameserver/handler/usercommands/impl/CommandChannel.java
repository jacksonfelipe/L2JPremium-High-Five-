...
import premium.gameserver.network.serverpackets.ExMultiPartyCommandChannelInfo;
	...
	public boolean useUserCommand(int id, Player activeChar)
	{
		...
		switch (id)
		{
			...
			case 93: // channeldelete
				...
				{
					premium.gameserver.model.CommandChannel channel = activeChar.getParty().getCommandChannel();
