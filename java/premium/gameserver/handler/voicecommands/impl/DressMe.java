...
import premium.gameserver.data.xml.holder.DressCloakHolder;
import premium.gameserver.data.xml.holder.DressShieldHolder;
import premium.gameserver.data.xml.holder.DressWeaponHolder;
...
import premium.gameserver.model.DressShieldData;
import premium.gameserver.model.DressWeaponData;
import premium.gameserver.model.Player;
import premium.gameserver.model.World;
import premium.gameserver.model.items.Inventory;
import premium.gameserver.model.items.ItemInstance;
import premium.gameserver.network.clientpackets.RequestPreviewItem.RemoveWearItemsTask;
import premium.gameserver.network.serverpackets.CharInfo;
import premium.gameserver.network.serverpackets.ShopPreviewInfo;
import premium.gameserver.scripts.Functions;
import premium.gameserver.templates.item.ItemTemplate;
import premium.gameserver.templates.item.ItemType;
...
public class DressMe implements IVoicedCommandHandler
{
	...
	public Map<Integer, DressWeaponData> initMap(String type, Map<Integer, DressWeaponData> map)
	{
	...
	public void visuality(Player player, ItemInstance item, int visual)
	{
