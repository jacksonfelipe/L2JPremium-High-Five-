...
public class ReportBot implements IVoicedCommandHandler
{
	...
	public boolean useVoicedCommand(String command, Player activeChar, String args)
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.voicecommands.impl.randomcommands.message4", activeChar));
			return false;
		}
	...
	public void botReportcommand(Player activeChar, String typeofreport, String moreinfo)
	{
		if (Config.ENABLE_AUTO_HUNTING_REPORT)
		{
			if (activeChar.getTarget() != null && activeChar.getTarget().isPlayer() && !typeofreport.isEmpty())
			{
			...
			{
				activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.voicecommands.impl.randomcommands.message15", activeChar));
			}
		}
		else
		{
			activeChar.sendMessage(new CustomMessage("premium.gameserver.handler.voicecommands.impl.randomcommands.message16", activeChar));
		}
	}
