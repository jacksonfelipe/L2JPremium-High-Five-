...
import static premium.gameserver.model.Zone.ZoneType.no_restart;
import static premium.gameserver.model.Zone.ZoneType.no_summon;
...
public class Wedding implements IVoicedCommandHandler
{
	private static class CoupleAnswerListener implements OnAnswerListener
	{
		...
		public void sayYes()
		{
			...
			player1.sendMessage(new CustomMessage("premium.gameserver.model.L2Player.EngageAnswerYes", player2));
		}
		...
		public void sayNo()
		{
			...
			player1.sendMessage(new CustomMessage("premium.gameserver.model.L2Player.EngageAnswerNo", player2));
		}
	}
