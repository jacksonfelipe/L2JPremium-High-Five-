...
import premium.gameserver.vote.DDSConverter;
...
public class Captcha
{
	...
	/**
	 * Generation new Captcha ID Generation random Captcha Text Generating BufferedImage Sending BufferedImage as PledgeCrest to the Target Sending HTML Window with Captcha to the player
	...
	/**
	 * Getting data/html-en/captcha.htm HTML Replacing %captchaId% and %time% Sending it as HTML window
