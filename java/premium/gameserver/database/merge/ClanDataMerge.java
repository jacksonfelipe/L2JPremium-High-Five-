...
// {
// try (PreparedStatement oldServerStatement = oldServerCon.prepareStatement("SELECT clan_id, rank, privilleges FROM clan_privs"); PreparedStatement newServerStatement = newServerCon.prepareStatement("INSERT INTO clan_privs (clan_id, rank, privilleges) VALUES (?,?,?)"); ResultSet rset =
// oldServerStatement.executeQuery())
// {
// while (rset.next())
// {
// final int oldClanId = rset.getInt("clan_id");
...
// {
// try (PreparedStatement oldServerStatement = oldServerCon.prepareStatement("SELECT clan_id, skill_id, skill_level FROM clan_skills"); PreparedStatement newServerStatement = newServerCon.prepareStatement("INSERT INTO clan_skills (clan_id, skill_id, skill_level) VALUES (?,?,?)"); ResultSet rset =
// oldServerStatement.executeQuery())
// {
// while (rset.next())
// {
...
// try (PreparedStatement oldServerStatement = oldServerCon.prepareStatement("SELECT clan_id, type, name, leader_id FROM clan_subpledges"); PreparedStatement newServerStatement = newServerCon.prepareStatement("INSERT INTO clan_subpledges (clan_id, type, name, leader_id) VALUES (?,?,?,?)"); ResultSet
// rset = oldServerStatement.executeQuery())
// {
// while (rset.next())
// {
// final int oldClanId = rset.getInt("clan_id");
...
// {
// try (PreparedStatement oldServerStatement = oldServerCon.prepareStatement("SELECT clan_id, type, skill_id, skill_level FROM clan_subpledges_skills"); PreparedStatement newServerStatement = newServerCon.prepareStatement("INSERT INTO clan_subpledges_skills (clan_id, type, skill_id, skill_level)
...
// }
//
//// private void updateClanTable() / { / for (Integer newClanId : oldClanIdNewClanId.values()) / { / ClanTable.getInstance().restoreClan(newClanId); / } / }
//
