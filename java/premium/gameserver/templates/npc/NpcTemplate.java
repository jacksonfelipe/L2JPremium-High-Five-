...
import premium.commons.util.TroveUtils;
import premium.gameserver.ai.CharacterAI;
import premium.gameserver.data.xml.holder.FakePlayerNpcsHolder;
...
public final class NpcTemplate extends CharTemplate
{
	...
	private void setType(String type)
	{
		...
		try
		{
			classType = (Class<NpcInstance>) Class.forName("premium.gameserver.model.instances." + type + "Instance");
		}
	...
	private void setAI(String ai)
	{
		...
		try
		{
			classAI = (Class<CharacterAI>) Class.forName("premium.gameserver.ai." + ai);
		}
		catch (ClassNotFoundException e)
		{
