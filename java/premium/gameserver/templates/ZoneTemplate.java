package premium.gameserver.templates;
...
import premium.gameserver.model.Zone.ZoneTarget;
...
public class ZoneTemplate
{
	...
	/**
	 * Сообщение которое шлется при уроне от зоны (не скилла) К примеру на осадах. Пока это только 686 (You have received $s1 damage from the fire of magic.)
	 */
