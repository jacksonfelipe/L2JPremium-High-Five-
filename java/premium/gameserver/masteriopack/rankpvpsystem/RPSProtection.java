...
/**
 * Class contains some check methods. Each L2j pack use difference variables or method names, so this class is dedicated for each pack.
 * @author Masterio
 */
public class RPSProtection
{
	...
	/**
	 * If player on the event or on olympiad, return TRUE. This method can be difference for any l2jServer revisions.
	 * @param player
	 * @return
	 */
