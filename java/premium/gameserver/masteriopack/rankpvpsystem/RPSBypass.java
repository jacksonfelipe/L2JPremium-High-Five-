...
public class RPSBypass
{
	...
	{
		/*
		 * Commands: RPS.PS - PvP Status window. RPS.DS - Death Status window. RPS.RPC:<pageNo> - RPS Exchange window (default page number is: 1). RPS.RPCReward:<rewardId>,<pageNo> - Give RPC Reward for current player, and show RPC Exchange on pageNo. [The reward list is constant]
		 * RPS.RPCRewardConfirm:<rewardId>,<pageNo> - Confirm page for get reward. RPS.RewardList:<rankId>,<pageNo> - Rank Reward List for kill player with rank id, and show at pageNo.
		 */
