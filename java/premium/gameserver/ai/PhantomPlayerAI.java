...
import premium.gameserver.ai.DefaultAI.Task;
import premium.gameserver.ai.DefaultAI.TaskType;
...
import premium.gameserver.network.clientpackets.EnterWorld;
...
import premium.gameserver.randoms.LocationStorage;
...
import premium.gameserver.stats.funcs.FuncAdd;
	...
	private class RoamingTask implements Runnable
	{
		...
		public void run()
		{
			...
			else if (ai.getMood().contains("check npcs"))
			{
				...
				if ((target == null) || Rnd.chance(25)) // Dont go to many NPCs at a time.
				{
					rnd = Rnd.get(100); // New mood time...
				}
			}
