...
import premium.gameserver.data.xml.holder.AirshipDockHolder;
...
import premium.gameserver.templates.AirshipDock;
...
public final class AirshipDockParser extends AbstractFileParser<AirshipDockHolder>
{
	...
	private static List<BoatPoint> parsePoints(Element listElement)
	{
		if (listElement == null)
		{
