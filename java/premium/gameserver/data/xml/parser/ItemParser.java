...
import premium.gameserver.templates.item.Bodypart;
import premium.gameserver.templates.item.EtcItemTemplate;
			...
			for (Iterator<org.dom4j.Element> subIterator = itemElement.elementIterator(); subIterator.hasNext();)
			{
				...
				else if (subName.equalsIgnoreCase("attributes"))
				{
					...
					for (Iterator<org.dom4j.Element> nextIterator = subElement.elementIterator(); nextIterator.hasNext();)
					{
						...
						{
							premium.gameserver.model.base.Element element = premium.gameserver.model.base.Element.getElementByName(nextElement.attributeValue("element"));
