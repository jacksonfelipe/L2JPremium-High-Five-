...
import premium.gameserver.model.entity.events.actions.ActiveDeactiveAction;
import premium.gameserver.model.entity.events.actions.AnnounceAction;
import premium.gameserver.model.entity.events.actions.GiveItemAction;
import premium.gameserver.model.entity.events.actions.IfElseAction;
import premium.gameserver.model.entity.events.actions.InitAction;
import premium.gameserver.model.entity.events.actions.NpcSayAction;
import premium.gameserver.model.entity.events.actions.OpenCloseAction;
import premium.gameserver.model.entity.events.actions.PlaySoundAction;
import premium.gameserver.model.entity.events.actions.RefreshAction;
import premium.gameserver.model.entity.events.actions.SayAction;
import premium.gameserver.model.entity.events.actions.SpawnDespawnAction;
import premium.gameserver.model.entity.events.actions.StartStopAction;
import premium.gameserver.model.entity.events.actions.TeleportPlayersAction;
...
import premium.gameserver.model.entity.events.objects.FortressCombatFlagObject;
import premium.gameserver.model.entity.events.objects.SiegeToggleNpcObject;
import premium.gameserver.model.entity.events.objects.SpawnExObject;
import premium.gameserver.model.entity.events.objects.StaticObjectObject;
import premium.gameserver.model.entity.events.objects.TerritoryWardObject;
import premium.gameserver.model.entity.events.objects.ZoneObject;
...
import premium.gameserver.network.serverpackets.components.SysString;
...
public final class EventParser extends AbstractDirParser<EventHolder>
{
	...
	protected void readData(Element rootElement) throws Exception
	{
		for (Iterator<Element> iterator = rootElement.elementIterator("event"); iterator.hasNext();)
		{
			...
			try
			{
				eventClass = (Class<GlobalEvent>) Class.forName("premium.gameserver.model.entity.events.impl." + impl + "Event");
			}
			...
			set.set("id", id);
			set.set("name", name);
			set.set("eventClass", "premium.gameserver.model.entity.events.impl." + impl + "Event");
	...
	private static List<Serializable> parseObjects(Element element)
	{
		if (element == null)
		{
	...
	private List<EventAction> parseActions(Element element, int time)
	{
		...
		for (Iterator<Element> iterator = element.elementIterator(); iterator.hasNext();)
		{
			...
			//
			// EventAction action = new premium.gameserver.model.entity.events.actions.VoicedCommandToClanLeadersAction(bypass);
			// actions.add(action);
			// }
			...
			// String bypass = actionElement.attributeValue("bypass");
			//
			// EventAction action = new premium.gameserver.model.entity.events.actions.VoicedCommandToAllPlayersAction(bypass);
			// actions.add(action);
			// }
			...
			// String bypass = actionElement.attributeValue("bypass");
			//
			// EventAction action = new premium.gameserver.model.entity.events.actions.VoicedCommandToAllParticipantsAction(bypass);
			// actions.add(action);
			// }
