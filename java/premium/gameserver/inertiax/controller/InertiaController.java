package premium.gameserver.inertiax.controller;
 ...
 *  - IBypassHandler uses H5's premium.gameserver.handler.bypass.IBypassHandler
...
public class InertiaController implements IBypassHandler, IVoicedCommandHandler
{
	...
	public Inertia fetchInertia(final Player player)
	{
		...
		return _playerInertias.computeIfAbsent(objectId, id ->
		{
			...
			inertia.addInertiaExt(new premium.gameserver.inertiax.model.ext.PlayerExt());
			return inertia;
		});
	}
	...
	public void onBypassFeedback(final NpcInstance npc, final Player player, final String cmd)
	{
		...
		{
			final premium.gameserver.inertiax.model.panels.InertiaPath path = inertia.getSelectedPath();
