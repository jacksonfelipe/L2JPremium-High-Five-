...
import static premium.gameserver.inertiax.enums.IInertiaCmd.EInertiaEvt.EVT__ASSIST_NO_TARGET;
import static premium.gameserver.inertiax.enums.IInertiaCmd.EInertiaEvt.EVT__ATK_TARGET;
import static premium.gameserver.inertiax.enums.IInertiaCmd.EInertiaEvt.EVT__CREDIT_END;
import static premium.gameserver.inertiax.enums.IInertiaCmd.EInertiaEvt.EVT__END;
import static premium.gameserver.inertiax.enums.IInertiaCmd.EInertiaEvt.EVT__FOLLOW_CLOSE;
import static premium.gameserver.inertiax.enums.IInertiaCmd.EInertiaEvt.EVT__FOLLOW_FAR;
import static premium.gameserver.inertiax.enums.IInertiaCmd.EInertiaEvt.EVT__NEW_TARGET;
import static premium.gameserver.inertiax.enums.IInertiaCmd.EInertiaEvt.EVT__NO_TARGET;
import static premium.gameserver.inertiax.enums.IInertiaCmd.EInertiaEvt.EVT__ON_KILL;
import static premium.gameserver.inertiax.enums.IInertiaCmd.EInertiaEvt.EVT__REM_TARGET;
import static premium.gameserver.inertiax.enums.IInertiaCmd.EInertiaEvt.EVT__START;
import static premium.gameserver.inertiax.enums.IInertiaCmd.EInertiaEvt.EVT__WHILE_DEAD;
import static premium.gameserver.inertiax.enums.IInertiaCmd.EInertiaEvt.EVT__WHILE_TARGET_DEAD;
...
import premium.gameserver.inertiax.controller.InertiaController;
import premium.gameserver.inertiax.enums.EActionPriority;
import premium.gameserver.inertiax.enums.EAutoAttack;
import premium.gameserver.inertiax.enums.EMoveType;
import premium.gameserver.inertiax.enums.EPanelOption;
import premium.gameserver.inertiax.enums.ESearchType;
...
import premium.gameserver.inertiax.model.filters.ActionFilter;
import premium.gameserver.inertiax.model.filters.AvailSkillActionFilter;
import premium.gameserver.inertiax.model.filters.TargetFilter;
import premium.gameserver.inertiax.model.filters.VTargetFilter;
import premium.gameserver.inertiax.model.panels.DropTracker;
...
public class Inertia implements Callable<Inertia>
{
	...
	public void tick(final long ticks)
	{
		...
		if (actualTarget == null)
		{
			...
			{
				final premium.gameserver.inertiax.model.panels.InertiaPath path = getSelectedPath();
	...
	public premium.gameserver.inertiax.model.panels.InertiaPath getSelectedPath()
	{
		premium.gameserver.inertiax.model.InertiaPanel panel = getPanel(EPanelOption.Path_Editor);
		if (panel instanceof premium.gameserver.inertiax.model.panels.PathEditor)
		{
			premium.gameserver.inertiax.model.panels.PathEditor pe = (premium.gameserver.inertiax.model.panels.PathEditor) panel;
