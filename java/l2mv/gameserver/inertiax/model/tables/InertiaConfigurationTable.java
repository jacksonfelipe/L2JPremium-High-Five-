package l2mv.gameserver.inertiax.model.tables;
...
import l2mv.gameserver.inertiax.model.templates.InertiaConfiguration;
...
public class InertiaConfigurationTable
{
	...
	private void load() throws Exception
	{
		...
		{
			System.out.println("InertiaConfigurationTable: Warning: config folder " + templatesFolder.getAbsolutePath() + " does not exist!");
			return;
		}
		...
		if (files != null)
		{
			for (final File templateFile : files)
			{
