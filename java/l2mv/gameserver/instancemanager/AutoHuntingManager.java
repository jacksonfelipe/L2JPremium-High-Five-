...
public class AutoHuntingManager
{
	...
	public synchronized void reportBot(Player reported, Player reporter, String typeOfReport, String moreInfo)
	{
		...
		/*
		 * if (!reported.isInCombat() && !reported.isInPeaceZone()) { reporter.sendMessage(new CustomMessage("l2mv.gameserver.instancemanager.autohuntingmanager.message7", reporter)); return; }
		 */
