...
public class Teleport implements IVoicedCommandHandler
{
	...
	public boolean pvp(String command, Player activeChar, String args)
	{
	...
	public boolean farm(String command, Player activeChar, String args)
	{
	...
	public boolean farm_hard(String command, Player activeChar, String args)
	{
	...
	public boolean farm_low(String command, Player activeChar, String args)
	{
