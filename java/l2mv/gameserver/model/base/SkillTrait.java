...
public enum SkillTrait
{
	...
	/*
	 * public double calcResistMod(Env env) { final double vulnMod = calcVuln(env); final double profMod = calcProf(env); final double maxResist = 90. + Math.max(calcEnchantMod(env), profMod * 0.85); return (maxResist - vulnMod) / 60.; }
	 */
