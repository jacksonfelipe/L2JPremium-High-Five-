...
public class Recipe
{
	...
	/**
	 * Constructor<?> of l2fecipeList (create a new Recipe).<BR>
	 * <BR>
	 */
	...
	/**
	 * Add a l2fecipeInstance to the l2fecipeList (add a line Item-Quantity needed to the Recipe).<BR>
	 * <BR>
	 */
	...
	/**
	 * Return the crafting level needed to use this l2fecipeList.<BR>
	 * <BR>
	 */
	public int getLevel()
	{
	...
	/**
	 * Return the Identifier of the l2fecipeList.<BR>
	 * <BR>
	 */
	...
	/**
	 * Return the name of the l2fecipeList.<BR>
	 * <BR>
	 */
	...
	/**
	 * Return the crafting success rate when using the l2fecipeList.<BR>
	 * <BR>
	 */
	...
	/**
	 * Return the crafting MP cost of this l2fecipeList.<BR>
	 * <BR>
	 */
	...
	/**
	 * Return the Identifier of the Item crafted with this l2fecipeList.<BR>
	 * <BR>
	 */
	...
	/**
	 * Return the quantity of Item crafted when using this l2fecipeList.<BR>
	 * <BR>
	 */
	public int getCount()
	{
	...
	/**
	 * Return the table containing all l2fecipeInstance (1 line of the recipe : Item-Quantity needed) of the l2fecipeList.<BR>
	 * <BR>
	 */
