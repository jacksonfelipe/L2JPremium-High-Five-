...
// {
// try (Connection con = StreamDatabaseFactory.getStreamDatabaseConnection(); PreparedStatement statement = con.prepareStatement("UPDATE streams SET connected_player_id=?, connected_player_server=?, ids_awaiting_approval = ?, not_rewarded_seconds = ?, total_rewarded_seconds_today = ?,
// punished_until_date = ? WHERE channel_name=?"))
// {
