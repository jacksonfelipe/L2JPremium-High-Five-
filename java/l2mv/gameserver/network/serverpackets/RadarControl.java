...
/**
 * Примеры пакетов: Ставит флажок на карте и показывает стрелку на компасе: EB 00 00 00 00 01 00 00 00 40 2B FF FF 8C 3C 02 00 A0 F6 FF FF Убирает флажок и стрелку EB 02 00 00 00 02 00 00 00 40 2B FF FF 8C 3C 02 00 A0 F6 FF FF
 */
