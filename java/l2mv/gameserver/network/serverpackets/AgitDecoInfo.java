...
public class AgitDecoInfo extends L2GameServerPacket
{
	...
	/**
	 * В коментах: Первое число = присланое сервером, второе уровень установленый в кланхолле Пример: mp recovery: 0 = 0 значит что уровень 0 прислал 0, уровни 5 и 15 прислали 1, уровни 25, 35, 50 прислали 2 кажись нигде ничего не напутал...
	 */
	private int _id;
